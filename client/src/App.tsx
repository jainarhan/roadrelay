...
const PublicRoute: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  if (loading) {
    return (
      <div className="flex h-screen w-screen items-center justify-center bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
        <span className="text-gray-600 dark:text-gray-400 font-medium">Loading session...</span>
      </div>
    );
  }
